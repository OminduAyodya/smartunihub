    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-amber-50/30 p-8 shadow-soft">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-3xl font-extrabold text-slate-900">ANOHANA - Offers & Promotions</h2>
            <p className="mt-2 text-slate-600">
              Check out the latest deals & discounts at <span className="font-bold text-amber-700">ANOHANA (Main Building)</span>
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-emerald-100/30 p-8 text-center shadow-soft">
        ...
        <p className="mt-2 text-slate-600 max-w-2xl mx-auto">
          Visit ANOHANA today and enjoy our amazing offers. Check back regularly for new promotions!
        </p>
        <button
          type="button"
          onClick={() => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4">
          <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl">
            ...
            <div className="space-y-4 p-5">
              ...
              <button
                type="button"
                onClick={() => navigate("/anohana/food-stock")}
...
export default AnohanaOffersPage;
